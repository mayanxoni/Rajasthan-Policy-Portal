    ...
    <div class="about-section">
      <div class="about-us">
        <div class="col-md-12 " style="width:100%;">
          <h3 style="padding: 0px 0px 30px 0px;">ABOUT US</h3>
          <div class="abt_image"> <img src="images/abt_pic1.png" alt="" /> </div>
          <p>Rajasthan also has a great number of schemes applicable across various sectors to facilitate or provide service or benefit the citizen of state. The schemes can belong both to Union Government or State Government and can be run by various union, state or local authorities.</p> 
          <div style="pa">
